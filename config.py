...
WUXING_INDUSTRY_MAP = {
    "火": {
        "industries": ["军工", "新能源", "半导体", "能源", "煤炭", "石油", "电力", "芯片", "储能", "光伏", "汽车", "传媒", "安防", "软件"],
        "keywords": ["军工", "导弹", "战争", "冲突", "芯片", "半导体", "光伏", "新能源", "石油", "煤炭", "电力", "储能", "电池", "能源", "核能", "火箭", "汽车", "传媒", "视频", "互联网", "安防", "监控", "软件", "ERP", "SaaS"],
...
STOCK_POOL = {
    "A股": {
        ...
        "新能源": [
            ...
            {"name": "明阳智能", "code": "601615", "pe": 18.0, "pb": 1.5, "market_cap": "450亿", "reason": "海上风电整机龙头+政策驱动"},
        ],
        "银行": [
        ...
        "半导体": [
            ...
            {"name": "寒武纪", "code": "688256", "pe": -1, "pb": 18.0, "market_cap": "1200亿", "reason": "国产AI芯片龙头"},
            {"name": "盛科通信", "code": "688702", "pe": -1, "pb": 12.0, "market_cap": "300亿", "reason": "以太网交换芯片稀缺标的"},
        ],
        "酒类": [
        ...
        "煤炭": [
            ...
            {"name": "潞安环能", "code": "601699", "pe": 6.5, "pb": 0.9, "market_cap": "500亿", "reason": "喷吹煤龙头+迎峰度夏"},
        ],
        "电力": [
            ...
            {"name": "国电南瑞", "code": "600406", "pe": 25.0, "pb": 3.5, "market_cap": "1800亿", "reason": "电网二次设备龙头+六张网核心"},
        ],
        "钢铁": [
        ...
        "通信": [
            ...
            {"name": "工业富联", "code": "601138", "pe": 18.0, "pb": 3.5, "market_cap": "4000亿", "reason": "AI服务器代工龙头+英伟达GB系列"},
            {"name": "华工科技", "code": "000988", "pe": 30.0, "pb": 3.8, "market_cap": "300亿", "reason": "光模块+激光设备双驱动"},
        ],
        "消费": [
            ...
            {"name": "安井食品", "code": "603345", "pe": 22.0, "pb": 3.5, "market_cap": "350亿", "reason": "速冻食品龙头+预制菜"},
            {"name": "华统股份", "code": "002840", "pe": 30.0, "pb": 2.5, "market_cap": "120亿", "reason": "肉牛养殖，牛周期反转"},
            {"name": "东鹏饮料", "code": "605499", "pe": 35.0, "pb": 15.0, "market_cap": "1100亿", "reason": "能量饮料龙头+Q2旺季"},
        ],
        "传媒": [
        ...
        "安防": [
            {"name": "海康威视", "code": "002415", "pe": 18.0, "pb": 3.5, "market_cap": "2800亿", "reason": "AIoT安防龙头+观澜大模型赋能"},
        ],
        "软件": [
            {"name": "用友网络", "code": "600588", "pe": -1, "pb": 4.0, "market_cap": "500亿", "reason": "国产ERP龙头+AI加持BIP3"},
        ],
        "保险": [
            ...
            {"name": "中国人保", "code": "601319", "pe": 8.5, "pb": 0.95, "market_cap": "3500亿", "reason": "财险龙头+高股息防御"},
        ],
        "化工": [
            ...
            {"name": "新和成", "code": "002001", "pe": 14.0, "pb": 2.2, "market_cap": "600亿", "reason": "维生素龙头+VE/VA涨价预期"},
        ],
        "有色": [
            ...
            {"name": "赤峰黄金", "code": "600988", "pe": 25.0, "pb": 4.0, "market_cap": "400亿", "reason": "黄金采选+地缘避险受益"},
        ],
    },
    "美股": {
        "科技": [
...
RISK_WARNING = (
    "⚠️ 免责声明与限制性提示\n\n"
    "本内容仅为基于宏观政策与公开信息的逻辑推演和整理呈现，不构成任何形式的投资建议、买卖指令或证券推荐。\n"
    "投资与交易（含股票、期货、期权等衍生品）涉及巨大风险，包括但不限于本金完全亏损的风险、杠杆放大亏损的风险。\n\n"
    "【期货/期权专项风险提示】\n"
    "• 期货和期权交易风险极高，保证金机制可能造成超过本金投入的亏损，不适合普通投资者。\n"
    "• 所有期货/期权策略基于「五行承载力+量价齐生」的框架推演，仅为内部讨论建模使用，不保证任何收益率，更不构成对任何交易的方向确定性承诺。\n"
    "• 必须遵守中国证监会相关规定，在参与交易前联系持牌人员了解全部合同与风险，并根据自身财务状况和风险承受能力独立决策。\n"
    "• 严禁使用借贷资金或生活必用资金参与任何衍生品交易。\n"
    "• 必须设置硬性止损线：单一品种单笔亏损建议不超过账户总值的2%-5%（按自身风险承受能力设定）。\n\n"
    "【八字五行推演声明】\n"
    "• 八字五行推演属于传统文化与历史经验总结，不构成任何形式的投资建议、买卖指令或收益承诺。\n"
    "• 本系统不对任何依据本系统内容进行的交易行为产生的任何直接或间接损失承担任何责任。\n"
    "• 所有「买入/卖出/追/等/撤」信号均为框架性推演，不代表对未来涨跌结果的确定性承诺。\n\n"
    "任何依据本系统进行的真实交易而产生的亏损，本系统与服务商不承担任何责任。\n"
    "市场风险莫测，投资须怀敬畏之心。\n"
    "祝交易顺利！风险自行把握。"
)
